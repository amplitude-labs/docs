...
<Info>
  **Prerequisite**: Please onboard and get a paid API key from our
  [console](https://justextract.it/console) before proceeding.
</Info>
...
```bash npm
npx justextract.it --init
```

</CodeGroup>

**Step 2**: Copy the code below to make a `fetch` request:
